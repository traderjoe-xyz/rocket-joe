task("launch", "Deploy's an ERC20 token and creates a launch event")
  ...
  .addParam('maxpenalty', 'The maximum of the variable withdraw penalty in phase 1')
  ...
  .setAction(async (taskArgs) => {
    ...
    // Create launch event.
    const rocketFactory = await hre.ethers.getContractAt("RocketJoeFactory", taskArgs.rocketfactoryaddress);
